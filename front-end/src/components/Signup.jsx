...
const Signup = () => {
  return (
      <div className=' bg-linear-to-r from-[#000000] to-[#002063] w-full h-screen flex justify-center items-center flex-col'>
        ...
        <div> 
            <h1 className='text-4xl text-white anta-regular font-normal '>Create Your Account</h1>
         ...
         <form action="" className=' w-full flex flex-col gap-5 ' >
            ...
            <input type="email" placeholder='email' name="" id="" className='text-[16px] p-4 rounded-[9px] bg-white text-black outline-none' />
            <button className=' cursor-pointer bg-[#003DBD] hover:bg-[#1900bd] w-full p-4 rounded-[9px] text-white outline-none text-[20px] tracking-[2px] anta-regular font-normal'>Signup</button>
           <div>
           <p className=' text-white text-center text-[16px]'>Already have an account? <a href="/login" className='text-[#000D28] cursor-pointer hover:underline outline-none'>SignIn</a></p>
