      ...
      <div className='p-[16px] flex flex-col justify-between w-[256px] h-[161px] m-[10px] bg-white rounded-[14px]'>
        <div className='flex justify-between items-start'>
          <div className='flex flex-col w-[70%] justify-between items-start gap-[16px]'>
            <p className='nunito-sans font-semibold text-[#3a3e42]/70 text-[16px]'>{title}</p>
            <div className='w-[96px] h-[38px] '>
              <h1 className='nunito-sans font-bold text-[28px] '>{total}</h1>
            </div>


          </div>
          <div className='flex'>
            <div style={{backgroundColor : "white"}} className="w-[60px] h-[60px] flex items-center justify-center rounded-[20px] bg-white  ">
              <img src={icon} alt="Group" className='w-[32px] h-[24px]' />
            </div>
