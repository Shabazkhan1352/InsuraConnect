...
const Sidebar = () => {
    ...
    const menuItems = [
        { name: "Overview", path: "/userpanel", icon: <img className=" hover:invert-100" src={overviewIMG} alt="" /> },
        { name: "My Policies", path: "/policies", icon: <img src={mypoliciesIMG} alt="" /> },
        { name: "Products", path: "/product", icon: <img src={productsIMG} alt="" /> },
        { name: "claims", path: "/claims", icon: <img src={claimsIMG} alt="" /> },
